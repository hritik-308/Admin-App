...
export default function LoginScreen({navigation}) {
  ...
  if (!confirm) {
    ...
    return (<>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Image source={require('../Images/otpp.png')} style={{height:50,width:40,padding:65,marginTop:25,marginLeft:100}}/>
        <View style={{flexDirection: 'row',marginTop: 80,}}>
          <Text style={{fontSize: 31,padding:4, fontWeight: 'bold', color: COLORS.dark}}>
            Enter 
          </Text>
          <Text style={{fontSize: 31,padding:4, fontWeight: 'bold', color: COLORS.secondary}}>
            Your  
          </Text>
          <Text style={{fontSize: 31, padding:4,fontWeight: 'bold', color: COLORS.dark}}>
            Phone,
          ...
          <Text style={{fontSize: 14, fontWeight: 'bold', color: COLORS.light}}>
            You Will Receive a 6 digit code for phone number verification
          </Text>
      </ScrollView>
    </SafeAreaView>
      <View style={{padding:90,justifyContent:'center',alignItems:'center',backgroundColor:COLORS.white,}}>
      <PhoneInput 
  ...
  underlayColor='#226557'>
    <Text style={{color: 'black',textAlign:'center',marginRight:10,marginLeft:16}}>Continue  </Text>
</TouchableHighlight>
<Text style={{color: COLORS.light, fontWeight: 'bold',padding:13,}}>
   ...
   return (
    ...
    <View style={{flex:1,justifyContent:'center',alignItems:'center',borderRadius:1}}>
      ...
      <Text style={{margin:4,fontWeight: 'bold', fontSize: 37, color: COLORS.dark, }}>
        Phone
      </Text>
      </View>
      <Image source={require('../Images/otps.png')} style={{height:50,width:40,padding:65,marginTop:25,marginLeft:48}}/>
